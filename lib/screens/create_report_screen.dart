...
class _EditableSaaSDescriptionCardState extends State<EditableSaaSDescriptionCard> {
  // 1. Controller to manage text input
  ...
  void initState() {
    ...
    _controller = TextEditingController(
      text: 'The purpose of this snagging inspection is to provide a comprehensive and detailed evaluation of the visible areas of the property. Our objective is to identify deviations from standard construction specifications, ensuring structural integrity, aesthetics...',
    );
  }
  ...
  @override
  Widget build(BuildContext context) {
    const Color primaryGreen = Color(0xFF2E7D32); // Defined for the example
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(8),
        side: BorderSide(color: Colors.grey.shade200), // Professional subtle border
      ),
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            // Header Row: SaaS pattern usually puts the action button on the top right
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(
                ...
                TextButton.icon(
                  ...
                  style: TextButton.styleFrom(
                    foregroundColor: _isEditing ? primaryGreen : Colors.blueAccent,
            ...
            AnimatedSwitcher(
              ...
              child: _isEditing
                ...
                padding: const EdgeInsets.all(12),
                decoration: BoxDecoration(
                  border: const Border(left: BorderSide(color: primaryGreen, width: 4)),
